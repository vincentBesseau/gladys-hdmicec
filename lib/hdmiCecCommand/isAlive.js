if ( typeof sails !== 'undefined' && sails ) {
    ...
    module.exports = function isAlive(options){
        console.log('debug',options.deviceId)
        return gladys.utils.sqlUnique(queries.getIdentifier,[options.deviceId])
        .then((row) => {
            ...
            .then(function(deviceType) {
                var json = '{"_type":"executeCommand","_command":"isAlive","_option":"'+deviceType.id+'"}'
